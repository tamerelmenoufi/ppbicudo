        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <?php
                  $query = "select a.*, b.nome as usuario_nome, o.nome as origem_nome, (select count(*) from relatorio where planilha = a.codigo) as registros from planilhas a left join usuarios b on a.usuario = b.codigo left join origens o on a.origem = o.codigo order by a.data desc limit 10";
