<?php
    ...
    if($_POST['delete']){
      // $query = "delete from atendentes where codigo = '{$_POST['delete']}'";
      $query = "update atendentes set deletado = '1' where codigo = '{$_POST['delete']}'";
      sisLog($query);
    }

    if($_POST['situacao']){
      $query = "update atendentes set situacao = '{$_POST['opc']}' where codigo = '{$_POST['situacao']}'";
      sisLog($query);
      exit();
    }
...
<div class="col">
  <div class="m-3">
    ...
    <div class="row">
      <div class="col">
        <div class="card">
          <h5 class="card-header">Lista de Atendentes</h5>
          <div class="card-body">
            ...
            <div class="table-responsive d-none d-md-block">
              <table class="table table-striped table-hover">
                ...
                <tbody>
                  <?php
                    $query = "select * from atendentes where deletado != '1' {$where} order by nome asc";
                    $result = sisLog($query);
