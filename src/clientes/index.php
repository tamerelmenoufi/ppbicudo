<?php
    ...
    if($_POST['delete']){
      ...
      $query = "update clientes set deletado = '1' where codigo = '{$_POST['delete']}'";
      sisLog($query);
    }

    if($_POST['situacao']){
      $query = "update clientes set status = '{$_POST['opc']}' where codigo = '{$_POST['situacao']}'";
      sisLog($query);
      exit();
    }
          ...
          <div class="card-body">
            ...
            <div class="table-responsive d-none d-md-block">
              <table class="table table-striped table-hover">
                ...
                <tbody>
                  <?php
                    $query = "select * from clientes where deletado != '1' and LENGTH(telefone) = 15 {$where} order by nome asc";
                    $result = sisLog($query);
            ...
            <div class="d-block d-md-none d-lg-none d-xl-none d-xxl-none">
            <?php
                  $query = "select * from clientes where deletado != '1' {$where} order by nome asc";
                  $result = sisLog($query);
