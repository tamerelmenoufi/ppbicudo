              ...
              <div class="row g-0">
                ...
                <div class="col">
                  <div class="card m-2">
                    <table class="table table-hover">
                      <tr>
                        <th>Lucro:</th><td>R$ <?=(number_format($totalLucro, 2,',','.'))?> (<?=(number_format($totalLucro/$totalValorPedidoXquantidade*100, 2,',',false))?>%)</td>
                      </tr>
                      <tr>
                        <th>Deconto:</th><td>R$ <?=(number_format($devolucaoLucro, 2,',','.'))?> (<?=(number_format($devolucaoLucro/$totalValorPedidoXquantidade*100, 2,',',false))?>%)</td>
                      </tr>
                      <tr>
